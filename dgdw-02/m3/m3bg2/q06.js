// address=13523 contains region=4
var r = db.dim.findOne({c_address_pk:13523},{'city.nation.region.region_geo':1});
r = r.city[0].nation[0].region[0]

var result = db.dim.aggregate([
   {
      $match: {
          'city.nation.region.region_geo': {
             $geoIntersects: {
